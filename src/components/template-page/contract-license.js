...
import ContractLicenseText from '../template-page-text/contract-license-text';
...
const ContractLicenseForm = ({changeData}) => {

return (
    <div id='quests' className='form-row forms'>
	...
	<p>Город</p>
		...
		<p> Данные лицензиара (того, кто предоставляет лицензию) </p>
		...
		<p> Данные лицензиата (того, кто использует лицензию) (</p>
...
export default WithTemplate(ContractLicenseForm, ContractLicenseText);
